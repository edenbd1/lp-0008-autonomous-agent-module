...
- [x] **MET — A recorded video demo of the end-to-end flow is included in the
  ...
  Two narrated films, published as release assets of this repository:

  - **[Film 1 — anchoring, verification and the refusal path](https://github.com/edenbd1/lp-0008-autonomous-agent-module/releases/download/demo-v1/lp8-film1.mp4)** (10 m 55 s)
  - **[Film 2 — one agent paying another, unattended](https://github.com/edenbd1/lp-0008-autonomous-agent-module/releases/download/demo-v1/lp8-film2.mp4)** (11 m 02 s)
  - subtitles: [film 1](https://github.com/edenbd1/lp-0008-autonomous-agent-module/releases/download/demo-v1/lp8-film1.srt),
    [film 2](https://github.com/edenbd1/lp-0008-autonomous-agent-module/releases/download/demo-v1/lp8-film2.srt)
    — release [`demo-v1`](https://github.com/edenbd1/lp-0008-autonomous-agent-module/releases/tag/demo-v1)

  Checked the way a reviewer reaches them rather than the way the author
  uploaded them: an unauthenticated `curl` of the second film returns HTTP 200
  and a body `file(1)` identifies as `ISO Media, MP4 Base Media v1`. A link that
  serves a login page to everyone but its owner is the failure mode here, and it
  is not this one.
