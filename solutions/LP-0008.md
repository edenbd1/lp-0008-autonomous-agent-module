...
- [ ] **UNMET — A recorded video demo of the end-to-end flow is included in the
  ...
  **Cause: filmed and verified, not published. This is the one unchecked box.**
  **Two narrated films exist and neither is at a URL**, which is the whole of
  what is missing: the criterion says the demo is *included in the submission*,
  and a local `.mp4` nobody can open is not included in anything. Nothing in this
  repository can close that — it is a link, and the link does not exist yet.
